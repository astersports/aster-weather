...
export const SKY_CONDITIONS: readonly SkyCondition[] = [
 ...
 */
export const SKY_TINTS: Record<SkyCondition, readonly [string, string]> = {
  "clear":                ["#446FA0", "#2E5A8C"],
 ...
 */
export function skyConditionFor(icon: WeatherIconKey, isDay = true): SkyCondition {
...
export function skyGradient(cond: SkyCondition): string {
...
export const ROUTED_ICON_KEYS: ReadonlySet<string> = new Set<WeatherIconKey>([
  "clear", "mostly-clear", "partly-cloudy", "overcast", "fog", "drizzle",
