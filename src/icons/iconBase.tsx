...
export const DAY_CLOUD: readonly [string, string] = ["#22314F", "#38507E"];
/** Night cloud duotone (cream) — legible on dark cards. */
export const NIGHT_CLOUD: readonly [string, string] = ["#C9D2E0", "#93A0BB"];

/** Pick the cloud duotone for the current day/night treatment. */
export function cloudStops(isDay: boolean): readonly [string, string] {
