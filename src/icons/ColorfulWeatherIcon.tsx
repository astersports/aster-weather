 ...
 */
export const ROUTED_ICON_KEYS: ReadonlySet<string> = new Set([
  "clear",
  "mostly-clear",
  "partly-cloudy",
  "overcast",
...
export function ColorfulWeatherIcon({
  icon,
  className = "w-4 h-4",
  isDay = true,
  label,
  ...
  switch (icon) {
    case "clear":
    case "mostly-clear":
      return isDay ? <SunnyIcon {...base} /> : <ClearNightIcon {...base} />;
    case "partly-cloudy":
      return isDay ? <PartlyCloudyIcon {...base} /> : <PartlyCloudyNightIcon {...base} />;
    case "overcast":
      return <OvercastIcon {...base} />;
    case "fog":
      return <FogIcon {...base} />;
    case "drizzle":
    case "light-rain":
      return <DrizzleIcon {...base} />;
    case "rain":
      return <RainIcon {...base} />;
    case "freezing-rain":
      return <FreezingRainIcon {...base} />;
    case "heavy-rain":
      return <HeavyRainIcon {...base} />;
    case "light-snow":
    case "snow":
    case "heavy-snow":
      return <SnowIcon {...base} />;
    case "thunderstorm":
      return <ThunderstormIcon {...base} />;
    default:
